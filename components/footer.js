      ...
      <div className="footer-max-width max-content-container">
        <div className="footer-bottom-container">
          <div className="footer-left-side">
            <img
              alt="image"
              src="/playground_assets/yodo1-1200w.jpg"
              className="footer-image"
            />
            <span className="footer-text">
              As a Global Partner connect with our team 
            </span>
            <div className="footer-social-media">
              <span className="footer-text01">FOLLOW YODO!</span>
          ...
          <div className="footer-links">
            <div className="footer-container1">
              <span className="footer-text02">MAS</span>
